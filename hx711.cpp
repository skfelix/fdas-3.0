...
static const char *device_name = "hx711";
...
int main (int argc, char *argv[]) {
	...
	/* Declaration of file */
	FILE *fptr;
    fptr = fopen ("/root/iio-non/output_data/hx711.txt", "w");
    if(fptr == NULL) {
	...
	// channel sequence: 0-voltage1, 1-voltage0
	// voltage1 attribute sequence: 0-scale_available, 1-raw, 2-scale
	// voltage0 attribute sequence: 0-raw, 1-scale_available, 2-scale
